...
FDamageEffectParams UAuraDamageGameplayAbility::MakeDamageEffectParamsFormClassDefaults(AActor* TargetActor) const
{
	...
	// Set by default, in firebolt its override
