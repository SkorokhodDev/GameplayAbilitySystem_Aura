...
public:
	...
	virtual FAuraGameplayEffectContext* Duplicate() const // Fix: change return to FAuraGameplayEffectContextType
	{
...
// important struct for our custom GameplayEffectContext
template <>
